...
/**
 * @brief Closes the "raw" I/O object
...
/**
 * @brief Reads from the "raw" I/O object with input CRLF normalization
 * @param io The I/O abstraction to interact with
...
/**
 * @brief Writes to the "raw" I/O object with output CRLF normalization
 * @param io The I/O abstraction to interact with
...
/**
 * @brief Passes ioctls through to the backing "raw" I/O interface
 * @param io The I/O abstraction to interact with
...
/**
 * @brief Writes a character to the backing I/O if it is not in error state
 * @param c The character to be written
 * @param arg Pointer holding reference to the I/O abstraction and it's error state
 * @return None
 */
