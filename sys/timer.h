/*! @file timer.h
    @brief The interface necessary for the timer and alarms
...
/**
 * @brief The main struct used in the timer and alarm
 */
struct alarm {
    struct condition cond; ///< Condition variable
    struct alarm * next; ///< Holds a sorted collection of pending alarms
