...
/* Kirill Levchenko modified for ECE 391 in May 2024 and Jan 2025.
 * 
 *   1. Added compass rose.
 *   2. Removed showfile(); embed strings instead.
 *   3. I/O and system functions are now implemented in glue.c.
 *   4. A lot of minor changes to make the above work.
 */

#include <stdint.h>

#include "glue.h" // ugly, but it works
...
static void won_game(void)
{
  ...
  if (FROM_FIXED(stardate) - time_start > 0) {
    printf("Your efficiency rating is ");
