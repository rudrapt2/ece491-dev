...
TARGET_DIR  := /home/rudrapt2/sp26_ece391/mp2-sp26/gold
...
FILES_FOR_COPYING   := \
    ...
    sys/dev/virtio.c \
    sys/dev/virtio.h \
    sys/games/rule30-mp2.o \
    sys/games/trek-mp2.o \
    sys/conf.h \
    sys/console.c \
    sys/console.h \
    sys/device.c \
...
.PHONY: mp2_gold mp2_release copy_files preprocess_assembly check_clean
...
mp2_gold: preprocess_assembly
	$(call run-unifdef,-DMP2 -USTUDENT -t)

mp2_release: preprocess_assembly
	$(call run-unifdef,-DMP2 -DSTUDENT -t)